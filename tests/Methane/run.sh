...
export VOTCASHARE=$HOME/modules/votca/votca_dev/share/votca/
...
time xtp_parallel -e xqmultipole -f state.sql -o OPTIONFILES/xqmultipole.xml -s 0 -t 1 -c 1000 -j "run" > xqmultipole.log
...
# gprof ${HOME}/modules/votca/votca_dev/bin/xtp_run | gprof2dot | dot -Tpng -o profile.png
...
time xtp_parallel -e eqm -o OPTIONFILES/eqm.xml -f state.sql -s 0 -j "write"
sed -i "s/AVAILABLE/COMPLETE/g" eqm.jobs
sed -i '0,/COMPLETE/s/COMPLETE/AVAILABLE/' eqm.jobs
sed -i '0,/COMPLETE/s/COMPLETE/AVAILABLE/' eqm.jobs

time xtp_parallel -e eqm -o OPTIONFILES/eqm.xml -f state.sql -s 0 -j run -c 1 -t 1
...
time xtp_parallel -e iqm -o OPTIONFILES/iqm.xml -f state.sql -s 0 -j "write"
sed -i "s/AVAILABLE/COMPLETE/g" iqm.jobs
sed -i '0,/COMPLETE/s/COMPLETE/AVAILABLE/' iqm.jobs

time xtp_parallel -e iqm -o OPTIONFILES/iqm.xml -f state.sql -s 0 -j run -c 1 -t 1

time xtp_parallel -e iqm -o OPTIONFILES/iqm.xml -f state.sql -j "read"
...
time xtp_parallel -e qmmm -o OPTIONFILES/qmmm.xml -f state.sql -s 0 >qmmm.log
